...
all_covs<-lapply(list_of_inputs, apply_cv_on_data, design)
cov_big_df <- bind_rows(all_covs, .id = "mode")
cov_big_df$mode <- factor(cov_big_df$mode,
                          levels = c("mRNA", "phospho", "protein"),
                          labels = c("Coefficient Of Variation over mRNA samples",
                                     "Coefficient Of Variation over peptide samples",
                                     "Coefficient Of Variation over protein samples"))
